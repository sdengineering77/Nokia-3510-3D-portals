...
public class MapLoader {
	public final static short SPAN_DATABLOCKSIZE	= 7;
	public final static short SPAN_LEFT				= 0;
	public final static short SPAN_RIGHT				= 1;
	public final static short SPAN_TOP					= 2;
	public final static short SPAN_BOTTOM				= 3;
	public final static short SPAN_ALIGN				= 4;
	public final static 	short _SPAN_ALIGN_LEFT			= 0;
	public final static 	short _SPAN_ALIGN_RIGHT			= 1;
	public final static 	short _SPAN_ALIGN_TOP			= 2;
	public final static 	short _SPAN_ALIGN_BOTTOM			= 3;
	public final static short SPAN_TEXTURE				= 5;
	public final static short SPAN_ANIMATED			= 6;
	
	public final static short CONN_PORT_DATABLOCKSIZE	= 6;
	public final static short CONN_PORT_LEFT			= 0;
	public final static short CONN_PORT_RIGHT			= 1;
	public final static short CONN_PORT_TOP			= 2;
	public final static short CONN_PORT_BOTTOM			= 3;
	public final static short CONN_PORT_ALIGN			= 4;
	public final static 	short _CONN_PORT_ALIGN_LEFT		= 0;
	public final static 	short _CONN_PORT_ALIGN_RIGHT		= 1;
	public final static 	short _CONN_PORT_ALIGN_TOP		= 2;
	public final static 	short _CONN_PORT_ALIGN_BOTTOM	= 3;
	public final static short CONN_PORT_REL_PORTAL_ID	= 5;
	

	public final static short PORTAL_DATABLOCKSIZE		= 16;
	public final static short PORTAL_BOTTOM_H 			= 0;
	public final static short PORTAL_BOTTOM_L 			= 1;
	public final static short PORTAL_LEFT_H  			= 2;
	public final static short PORTAL_LEFT_L  			= 3;
	public final static short PORTAL_FLOOR_H 			= 4;
	public final static short PORTAL_FLOOR_L 			= 5;
	public final static short PORTAL_CEIL_HEIGHT 		= 6;
	public final static short PORTAL_WIDTH		 		= 7;
	public final static short PORTAL_HEIGHT	 		= 8;
	public final static short PORTAL_TEXT_FLOOR		= 9;
	public final static short PORTAL_TEXT_CEIL	    	= 10;
	public final static short PORTAL_LIGHT	    		= 11;
	public final static short PORTAL_LIGHT_TYPE   		= 12;
	public final static short PORTAL_ID	    		= 13;
	public final static short PORTAL_NUM_REF_PORTALS	= 14;
	public final static short PORTAL_NUM_REF_SPANS		= 15;
...
//System.out.println( "mem after vp:" + Runtime.getRuntime().freeMemory() );
...
//long mem = Runtime.getRuntime().freeMemory();
			...
			connPortData = null;
			System.gc();
//long mem_af = Runtime.getRuntime().freeMemory();

//System.out.println( "freed:" + (mem_af-mem) );
//System.out.println( "mem:" + (mem_af) );
...
//System.gc();
//long mem = Runtime.getRuntime().freeMemory();
//System.out.println( "after quads:" + mem );
//System.gc();
...
System.gc();
long mem_after;
mem_after = Runtime.getRuntime().freeMemory();
System.out.println( "after portal + floor/ceil quads:" + (mem-mem_after) + "before: " + mem + " after " + mem_after);
//mem = mem_after;
...
System.gc();
//mem_after = Runtime.getRuntime().freeMemory();
//System.out.println( "after connPortBArray:" + (mem-mem_after) );
//mem = mem_after;
