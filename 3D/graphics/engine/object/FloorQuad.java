...
System.out.println("x_from_left[num_vectors_left]:  " + x_from_left[num_vectors_left-1]);					
System.out.println("y_from_left[num_vectors_left]:  " + y_from_left[num_vectors_left-1]);					
System.out.println("x_to_left[num_vectors_left]:    " + x_to_left[num_vectors_left-1]);					
System.out.println("y_to_left[num_vectors_left]:    " + y_to_left[num_vectors_left-1]);					
...
System.out.println("x_from_right[num_vectors_right]:  " + x_from_right[num_vectors_right-1]);					
System.out.println("y_from_right[num_vectors_right]:  " + y_from_right[num_vectors_right-1]);					
System.out.println("x_to_right[num_vectors_right]:    " + x_to_right[num_vectors_right-1]);					
System.out.println("y_to_right[num_vectors_right]:    " + y_to_right[num_vectors_right-1]);					
System.out.println("z_to_right[num_vectors_right]:    " + z_to_right[num_vectors_right-1]);					

				}

System.out.println("z_from:    " + z_from);					
System.out.println("z_to:      " + z_to);					
...
System.out.println("curr_y_from_right:               " + curr_y_from_right);					
System.out.println("currVectorIdx_right:             " + currVectorIdx_right);					
	
				// draw line
				if( poly_x_right_f > poly_x_left_f ) {
					int yx_left_local;
					int yx_right_local;
System.out.println("poly_x_left_f:             " + poly_x_left_f);					
System.out.println("viewportX_left_array[row]: " + viewportX_left_array[row]);					
System.out.println("poly_x_right_f:             " + poly_x_right_f);					
System.out.println("viewportX_right_array[row]: " + viewportX_right_array[row]);					
