 ...
 */
public class WallQuad implements Drawable {
...
//	public long			tSetup = 0;
//	public long 			tCull  = 0;
//	public long			tDraw  = 0;
//	public long			tHDraw  = 0;
//	public long			tVDraw  = 0;
		
	private final static short[] texture = new short[] { 
		(short)0xF0F0,(short)0xF0F0,(short)0xF00F,(short)0xF0F0,(short)0xF0F0,(short)0xF0F0,(short)0xF00F,(short)0xF0F0,
		(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,
		(short)0xF00F,(short)0xF0F0,(short)0xF0F0,(short)0xF0F0,(short)0xF00F,(short)0xF0F0,(short)0xF0F0,(short)0xF0F0,
		(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,
		(short)0xF0F0,(short)0xF0F0,(short)0xF00F,(short)0xF0F0,(short)0xF0F0,(short)0xF0F0,(short)0xF00F,(short)0xF0F0,
		(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,(short)0xF00F,
		(short)0xF00F,(short)0xF0F0,(short)0xF0F0,(short)0xF0F0,(short)0xF00F,(short)0xF0F0,(short)0xF0F0,(short)0xF0F0,
	...
	public WallQuad( int x1, int y1, int z1,
...
//tCull += (System.currentTimeMillis() - t1);
...
//tSetup += (System.currentTimeMillis() - t1);
...
/*				int x_diff_f 	= (ONE_F / (x_left - x_right));
				dy_top			= (int) (((long)(y_top_left - y_top_right) * x_diff_f)>>16) + scanheight_f; 
				dy_bottom		= (int) (((long)(y_bottom_left - y_bottom_right) * x_diff_f)>>16) + scanheight_f;
				int scan_offset = scanheight_f * x_left;
				y_bottom_left  += scan_offset;
				y_top_left	   += scan_offset;
*/
				int x_diff_f 		= (ONE_F / (x_left - x_right));
...
//long t2 = System.currentTimeMillis();
					...
					for( int rowCnt=y_top_local; rowCnt<y_bottom_local; rowCnt+=scanwidth) {
						...
						buffer[rowCnt] = texture[(((poly_v>>18)&0x00000038) + texture_h)];
